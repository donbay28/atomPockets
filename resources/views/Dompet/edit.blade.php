      ...
      <div class="row">
          <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                      <div class="table">
                          <form action="{{ url('/dompets/update') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" placeholder="Nama" value="{{$data_dompet['nama']}}" class="form-control" name="nama">
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label class="control-label">Referensi : </label>
                                      <input type="text" placeholder="Referensi" value="{{$data_dompet['referensi']}}" class="form-control" name="referensi">
                                  </div>
                              </div>
                              <div class="col-md-12">
                                  <div class="form-group">
                                      <label class="control-label">Deskripsi : </label>
                                      <textarea name="deskripsi" class="form-control">{{$data_dompet['deskripsi']}}</textarea>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
