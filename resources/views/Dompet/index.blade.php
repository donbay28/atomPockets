              ...
              <div class="col-md-7 align-self-center text-right">
                  <div class="d-flex justify-content-end align-items-center">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">Data Dompet</li>
                      </ol>
                  </div>
              </div>
          </div>
                      ...
                      <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              <a class="btn btn-info" href="{{url('/dompets/create')}}" role="button"><i class="fa fa-plus-circle"></i>Buat Baru</a>
                          ...
                          <tbody id="dataTab">
                            @foreach($data_dompet ?? '' ?? '' as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/dompets/show/'.$row->id)}}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa fa-eye"></i> Detail</a>
                                        <a href="{{url('/dompets/edit/'.$row->id)}}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pen"></i> Edit</a>
                                        @if ($row->status_id == 1)
                                            <a href="{{url('/dompets/changeStatus/'.$row->id.'/'.$row->status_id)}}" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Change To Tidak Aktif"><i class="fa fa-times"></i> Tidak Aktif</a>
                                        @else
                                            <a href="{{url('/dompets/changeStatus/'.$row->id.'/'.$row->status_id)}}" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Change To Aktif"><i class="fa fa-check"></i> Aktif</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
