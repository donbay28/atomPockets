      ...
      <div class="container-fluid">
          <div class="row page-titles">
              <div class="col-md-5 align-self-center">
                  <h4 class="text-themecolor">Dompet Keluar</h4>
              </div>
                      ...
                      <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              <a class="btn btn-info" href="{{url('/transaksis/createDompetKeluar')}}" role="button"><i class="fa fa-plus-circle"></i>Buat Baru</a>
