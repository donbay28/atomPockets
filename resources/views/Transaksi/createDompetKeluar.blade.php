      ...
      <div class="row">
          <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                      <div class="table">
                          <form action="{{ url('/transaksis/storeDompetKeluar') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="row">
                              <input type="hidden" value="WOUT-{{$kode}}" required class="form-control" name="code">
                              <input type="hidden" required class="form-control" name="tanggal" value="{{date('Y-m-d')}}">
                              <div class="col-md-3">
                                  <div class="form-group">
                                      <label class="control-label">Kode : </label>
                                      <input type="text" disabled value="WOUT-{{$kode}}" required class="form-control">
                                  </div>
                              </div>
                              <div class="col-md-3">
                                  <div class="form-group">
